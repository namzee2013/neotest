...
<div class="page-content-wrap">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="form-horizontal" action="{{route('admin.rate.store')}}" method="post">
              {{ csrf_field() }}
                  ...
                  <div class="form-group {{$errors->has('category_id') ? 'has-error' : ''}}">
                    ...
                    <div class="form-group {{$errors->has('index1') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="input-group">
                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                <input type="text" class="form-control" name="index1" value="{{old('index1')}}"/>
                            </div>
                    ...
                    <div class="form-group {{$errors->has('index2') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="input-group">
                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                <input type="text" class="form-control" name="index2" value="{{old('index2')}}"/>
                            </div>
