        ...
        <form class="form-horizontal" method="POST">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <h4>Add new Multi-choice Question</h4>     
...
<script type="text/javascript">
    ...
    $(".btn-add-more-option").on("click", function(e) {
        temp = '<div class="form-group option">'
            +'<label class="col-md-3 control-label"><input type="checkbox" name="correct['+i+']" value="'+i+'"> Option</label>'
            +'<div class="col-md-7">'
                +'<input type="text" class="form-control" name="option['+i+']" placeholder="Option content"/>'
            +'</div>'
