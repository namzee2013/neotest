...
<div class="page-content-wrap">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="form-horizontal" action="{{route('admin.user.update', $id)}}" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @if($user->avatar)
                    <div class="form-group {{$errors->has('repassword') ? 'has-error' : ''}}">
                        <label class="col-md-3 col-xs-12 control-label">Curent Avatar</label>
                        <div class="col-md-6 col-xs-12">
                            <div class="input-group">
                              <img width="100" src="{{asset('public/uploads/avatars/'.$user->avatar)}}" alt="">
                            </div>
                        </div>
                    </div>
                    @endif
